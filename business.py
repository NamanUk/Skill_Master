...
class BusinessFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.label_header = tk.Label(scroll_frame.scrollable_frame, text="Business", font=("Arial", 18, "bold"), bg='white', fg='black')
        self.label_header.pack(pady=(20, 10))

        details_text = (
            "This course covers essential business concepts including management, "
            "finance, marketing, and entrepreneurship. It provides the foundational "
            "knowledge needed to understand how businesses operate and succeed in a "
        ...
        self.label_question1 = tk.Label(scroll_frame.scrollable_frame, text="1. What is the main purpose of a business?", font=("Arial", 14), bg='white', fg='black')
        self.label_question1.pack(anchor='w', padx=20)
        self.var_q1 = tk.StringVar(value="")

        options_q1 = ["To provide products and services", "To make a profit", "To serve the community", "All of the above"]
        ...
        self.label_question2 = tk.Label(scroll_frame.scrollable_frame, text="2. What is entrepreneurship?", font=("Arial", 14), bg='white', fg='black')
        self.label_question2.pack(anchor='w', padx=20)
        self.var_q2 = tk.StringVar(value="")

        options_q2 = ["Starting a new business", "Investing in stocks", "Managing a team", "All of the above"]
    ...
    def submit_quiz(self):
        score = 0
        if self.var_q1.get() == "All of the above":
            score += 1
        if self.var_q2.get() == "Starting a new business":
            score += 1
...
if __name__ == "__main__":
    class MainApp(tk.Tk):
        def __init__(self):
            super().__init__()
            self.title("Business Course")
            self.geometry("400x500")
            self.switch_frame(BusinessFrame)
